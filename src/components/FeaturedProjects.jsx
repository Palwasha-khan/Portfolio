...
const featuredProjects = [
  {
    ...
    features: [
      ...
      'Express.js & node.js REST API backend architecture',
    ],
    tech: ['Python', 'OpenAI API', 'NLP','Express.js', 'React', 'Node.js', 'Tailwind CSS', 'MongoDB', 'REST API'],
  ...
  },
  {
    ...
    tech: ['MongoDB', 'Express.js', 'React', 'Node.js', 'Stripe API', 'Cloudinary', 'JWT', 'Bootstrap CSS'],
    gradientAccent: 'rgba(139,80,255,0.12)',
    badgeBg: 'rgba(139,80,255,0.15)',
    badgeColor: '#c4b0ff',
    badgeBorder: 'rgba(139,80,255,0.35)',
    codeUrl: 'https://github.com/Palwasha-khan/Sparkcart',
    demoUrl: 'https://sparkcart-1bvg.vercel.app/',
  },
];
